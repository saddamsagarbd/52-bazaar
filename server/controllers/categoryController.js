...
const getCategories = async (req, res) => {
    try {
        ...
        if (parent && Types.ObjectId.isValid(parent)) query.parent = new Types.ObjectId(parent);
...
export default { getCategories, addCategory, updateCategory, deactivateCategory }
